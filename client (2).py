...
def draw_rock(surf, x, y, w, h):
    ...
    pygame.draw.rect(surf, green, (ix + 2*w//3, iy + h//2, w//3, h//4), border_radius=3) 
    pygame.draw.rect(surf, green, (ix + 3*w//4, iy + h//4, w//4, h//3), border_radius=3) 
...
def main():
    ...
    while running:
        ...
        with _lock:
            current_phase = _latest_st.get('phase', 'splash') if _latest_st else 'splash'
